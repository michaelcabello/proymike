                    ...
                    <div class="product_d_right">
                        <form action="#">
                            <div>
                                 @foreach ($atributes as $groupName => $groupValues)
                                    <div>
                                        ...
                                        <select name="{{ $groupName }}" wire:model="selectedAttributes.{{$groupName}}" multiple>
                            ...
                            <h1>{{ $productfamilie->name }} </h1>
                             ...
                             <h1>Selected Attributes:</h1>
                            @foreach ($selectedAttributes as $groupName => $groupSelected)
                                <h2>{{ $groupName }}</h2>
                                <ul>
                                    @foreach ($groupSelected as $attribute)
                                        <li>{{ $attribute[1] }}</li>
                                    @endforeach
                                </ul>
                            @endforeach
