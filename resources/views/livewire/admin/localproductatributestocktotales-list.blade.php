        ...
        <x-slot name="header">
            <div class="flex items-center">
                <h2 class="text-xl font-semibold leading-tight text-gray-600">
                    Lista de Stock de productos en todos los Locales:  <a href="{{route('localproductatributestock.list', auth()->user()->employee->local->id )}}">Regresar</a>
                </h2>
            </div
                                    ...
                                    @foreach ($localproductatributes as $lpa)
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                {{ $lpa->local->name }} - {{ $lpa->local->address }}
                                            </td>
