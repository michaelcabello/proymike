                            ...
                            @foreach ($product->productatributes as $productatribute )
                                ...
                                <tr>
                                    ...
                                    <td class="flex w-32 gap-1 px-6 py-4 text-sm font-medium text-right whitespace-nowrap">
                                        ...
                                        <div>
                                            <form class="frmeliminar" method="POST" action="{{ route('admin.productatribute.destroy', $productatribute) }}">
                                                {{ csrf_field() }} {{ method_field('DELETE') }}

                                                <button type="submit" class="btn btn-red">
                                                    <i class="fa-solid fa-trash-can"></i>
                                                </button>
                                                {{--     <a class="btn btn-red frmeliminar">
                                                        <i class="fa-solid fa-trash-can">{{ $productatribute->id }}</i>
                                                    </a> --}}

                                                 {{-- @livewire('admin.productatributo-delete', ['productatribute' => $productatribute], key($productatribute->id)) --}}
                       ...
                       <div class="items-center gap-4 px-6 py-4 bg-gray-200 sm:flex">
                            ...
                            <a class="inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase transition bg-gray-800 border border-transparent rounded-md hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 " href="{{ route('admin.productatribute.pricewholesale', $product) }}" >
                             ...
                             <a class="inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase transition bg-red-800 border border-transparent rounded-md hover:bg-red-700 active:bg-red-900 focus:outline-none focus:border-red-900 focus:ring focus:ring-red-300 disabled:opacity-25 " href="{{ route('admin.productatribute.delete', $product) }}" >
                                <i class="mx-2 fa-regular fa-file"></i> Eliminar Activado
                            </a>
