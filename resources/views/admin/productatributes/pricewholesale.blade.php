            ...
            <x-table>
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <form method="POST" action="{{ route('admin.productatribute.updatepricewholesale') }}" >
                            {{ csrf_field() }}
                            {{--  {{ method_field('PUT')}} --}}
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-sm text-gray-500 whitespace-nowrap">
                                        ...
                                        <x-jet-input type="text" id="#p{{$productatribute->id}}"
                                            ...
                                            value="{{$productatribute->pricewholesale}}"
                                            class="flex items-center justify-center w-32  rounded-lg py-2.5"
                                            />
                                    </td>
                       ...
                       <div class="items-center gap-4 px-6 py-4 bg-gray-200 sm:flex">
                            ...
                            <a class="inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase transition bg-gray-800 border border-transparent rounded-md hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 " href="{{ route('admin.productatribute.codigo', $product) }}" >
                             ...
                             <a class="inline-flex items-center px-4 py-2 text-xs font-semibold tracking-widest text-white uppercase transition bg-gray-800 border border-transparent rounded-md hover:bg-gray-700 active:bg-gray-900 focus:outline-none focus:border-gray-900 focus:ring focus:ring-gray-300 disabled:opacity-25 " href="{{ route('admin.productatribute.pricesale', $product) }}" >
                                <i class="mx-2 fa-regular fa-file"></i> Modificar Precio por venta
                             </a>


                             <x-jet-danger-button type="submit" class="disabled:opacity-25">
                                <i class="mx-2 fa-regular fa-floppy-disk"></i> Guardar Precios de Venta por Mayor
                            </x-jet-danger-button>
